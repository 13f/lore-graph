/* json-hierarchy.js - v1.0.1.20190911
...
var JsonHierarchy = {
    ...
    limitedItems: 32, // 用于性能优化。对于array，只展示limitedItems条数据
	rootLabel_default: "ROOT", // priority: 0. e.g. "ROOT".
	rootLabel_usingTypeSign: true, // priority: 3. {} or []
	rootLabel_usingDataUri: false, // priority: 1.
    ...
    processData: function (url, json) {
        ...
        let tree = {
            title: this.rootLabel_usingDataUri ? url : this.rootLabel_default,
            description: url
        };

        let children = [];
        if (Array.isArray(json)) {
			if(this.rootLabel_usingTypeSign){
				tree.title = "[]";
			}
